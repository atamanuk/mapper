...
- [Project Architecture](architecture.md) — структура репозитория и расположение solution. Инженерные команды находятся в [../engineering/README.md](../engineering/README.md).
